  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#1a0a2e] via-[#16213e] to-[#0f0f1a]">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-violet-500/10 to-pink-500/10 rounded-full blur-3xl" />
      </div>
      <div
          ...
          >
            ...
            >
              <style>{`
                @keyframes pinkGlow {
                  0%, 100% {
                    filter:
                      ...
                      drop-shadow(0 0 20px #be185d)
                      drop-shadow(0 0 40px #9d174d);
                    opacity: 0.88;
                  }
                  50% {
                    filter:
                      drop-shadow(0 0 18px #f472b6)
                      drop-shadow(0 0 40px #ec4899)
                      drop-shadow(0 0 70px #be185d);
                    opacity: 1;
                  }
                }
                @keyframes floatLogo {
                ...
                .feminine-logo {
                  animation:
                    pinkGlow 2.6s ease-in-out infinite,
              ...
              <img
                src="/feminine.png"
                alt="NEBix Logo"
                className="feminine-logo w-52 h-52 object-contain"
              />
            </motion.div>
            ...
            >
              <h1 className="text-6xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-white via-pink-200 to-violet-200 bg-clip-text text-transparent">
                NEBix
              </h1>
              <motion.p
                initial={{ opacity: 0 }}
            ...
            >
              <span className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 animate-ping opacity-20" />
              <span className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 blur-md opacity-40 group-hover:opacity-60 transition-opacity" />
              <span className="relative flex items-center gap-3 px-8 py-4 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-white font-medium shadow-2xl shadow-pink-500/20 hover:bg-white/15 hover:border-white/30 transition-all duration-300">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              <motion.button
                ...
                className="group relative p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-pink-500/50 hover:bg-white/10 transition-all duration-500 text-left overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-600 to-violet-800 shadow-lg shadow-pink-500/30 mb-6">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    <span className="px-3 py-1 rounded-full bg-pink-500/20 text-pink-300 text-xs font-medium">Dashboard</span>
                    <span className="px-3 py-1 rounded-full bg-pink-500/20 text-pink-300 text-xs font-medium">Analytics</span>
                    <span className="px-3 py-1 rounded-full bg-pink-500/20 text-pink-300 text-xs font-medium">Alerts</span>
                  </div>
                </div>
                <div className="absolute bottom-8 right-8 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-pink-500 transition-colors duration-300">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    <span className="px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 text-xs font-medium">Tracker</span>
                    <span className="px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 text-xs font-medium">AI Chat</span>
                    <span className="px-3 py-1 rounded-full bg-violet-500/20 text-violet-300 text-xs font-medium">Wellness</span>
                  </div>
                </div>
