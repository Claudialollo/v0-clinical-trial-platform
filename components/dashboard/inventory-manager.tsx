...
import {
  ...
  Calendar, Search, Filter, Bell, RefreshCw, Plus,
  ArrowUp, ArrowDown, ChevronDown, ChevronUp, Download,
  Thermometer, BarChart3, Info
} from "lucide-react"
...
type TabId = "inventory" | "shipments" | "alerts"
...
const INVENTORY: InventoryItem[] = [
  {
    id: "INV-001",
    name: "KB Women Probiotic (Kaneka KABP052)",
    category: "probiotic",
    currentStock: 45,
    minStock: 60,
    unit: "boxes (30 caps)",
    batchNumber: "KNK-2026-A14",
  ...
  {
    id: "INV-002",
    name: "EDTA Tubes 4mL (purple cap)",
    category: "tube",
    currentStock: 8,
    minStock: 50,
    unit: "boxes (100 tubes)",
    batchNumber: "BD-2026-E41",
    expiryDate: "2026-05-15",
    storageTemp: "Room temperature",
    status: "critical",
    location: "Lab Storage — Cabinet 1",
    lastUpdated: "2026-04-14"
  },
  {
    id: "INV-003",
    name: "SST Tubes 5mL (yellow/red cap)",
    category: "tube",
    currentStock: 120,
    minStock: 50,
    unit: "tubes",
    batchNumber: "BD-2026-S22",
  ...
  {
    id: "INV-004",
    name: "Citrate Tubes 2.7mL (light blue cap)",
    category: "tube",
    currentStock: 35,
    minStock: 40,
    unit: "tubes",
    batchNumber: "BD-2026-C08",
  ...
  {
    id: "INV-005",
    name: "pTau181 ELISA Kit (Quanterix)",
    category: "kit",
    currentStock: 3,
    minStock: 4,
    unit: "kits (96 wells)",
    batchNumber: "QTX-2026-P91",
    expiryDate: "2026-07-31",
    storageTemp: "2–8°C",
    status: "low",
    location: "Fridge A — Lab",
    lastUpdated: "2026-04-12"
  },
  {
    id: "INV-006",
    name: "GFAP Simoa Kit (Quanterix HD-X)",
    category: "kit",
    currentStock: 5,
    minStock: 3,
    unit: "kits",
    batchNumber: "QTX-2026-G44",
  ...
  {
    id: "INV-007",
    name: "Informed Consent Forms (v2.1)",
    category: "consumable",
    currentStock: 15,
    minStock: 30,
    unit: "printed forms",
    batchNumber: "DOC-2026-IC21",
    expiryDate: "N/A",
    storageTemp: "Room temperature",
    status: "low",
    location: "Office — Filing Cabinet",
    lastUpdated: "2026-04-11"
  },
  {
    id: "INV-008",
    name: "Cryovials 1.8mL (Nunc)",
    category: "consumable",
    currentStock: 500,
    minStock: 200,
    unit: "vials",
    batchNumber: "NNC-2026-C18",
    expiryDate: "2029-12-31",
    storageTemp: "Room temperature",
    status: "ok",
    location: "Lab Storage — Cabinet 3",
...
const SHIPMENTS: Shipment[] = [
  {
    id: "SHP-001",
    description: "KB Women Probiotic restock — 120 boxes",
    quantity: "120 boxes",
    status: "in_transit",
    orderDate: "2026-04-12",
    expectedDate: "2026-04-18",
    trackingCode: "KNK-IT-2026-0412",
    supplier: "Kaneka Corporation"
  },
  {
    id: "SHP-002",
    description: "EDTA Tubes 4mL — 20 boxes emergency order",
    quantity: "20 boxes",
    status: "ordered",
  ...
  {
    id: "SHP-003",
    description: "pTau181 ELISA Kit — 6 kits",
    quantity: "6 kits",
    status: "delivered",
    orderDate: "2026-04-01",
    expectedDate: "2026-04-08",
    trackingCode: "QTX-IT-2026-0401",
    supplier: "Quanterix Europe"
  },
  {
    id: "SHP-004",
    description: "Citrate Tubes 2.7mL — 10 boxes",
    quantity: "10 boxes",
    status: "delayed",
    orderDate: "2026-04-05",
    expectedDate: "2026-04-10",
    trackingCode: "BD-IT-2026-0405",
    supplier: "BD Biosciences"
  },
]
...
const ALERTS: StockAlert[] = [
  ...
  {
    id: "ALT-004",
    itemName: "Informed Consent Forms v2.1",
    type: "low_stock",
            ...
            <div key={shipment.id} className={cn(
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-xs font-medium">{shipment.orderDate}</p>
                </div>
                <div>
                  <p className="text-[10px] text-muted-foreground">Quantity</p>
                  <p className="text-xs font-medium">{shipment.quantity}</p>
                </div>
                <div>
                  <p className="text-[10px] text-muted-foreground">Tracking</p>
                  <p className="text-xs font-medium font-mono">{shipment.trackingCode || "—"}</p>
                </div>
              </div>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={i} className="flex items-center justify-between">
              ...
              <div className={cn(
                "w-8 h-4 rounded-full flex items-center transition-all cursor-pointer",
